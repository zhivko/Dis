 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://telekom.si/services/common/customer/v1", wsdlLocation = "http://services.ts.telekom.si:80/services/common/customer/v1/CustomerService/v/1.8.0?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://telekom.si/services/common/customer/v1", "CustomerService");
     ...
     */
    @WebEndpoint(name = "CustomerSoapBindingPort")
    public ICustomerService getCustomerSoapBindingPort() {
        return super.getPort(new QName("http://telekom.si/services/common/customer/v1", "CustomerSoapBindingPort"), ICustomerService.class);
    }
     ...
     */
    @WebEndpoint(name = "CustomerSoapBindingPort")
    public ICustomerService getCustomerSoapBindingPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://telekom.si/services/common/customer/v1", "CustomerSoapBindingPort"), ICustomerService.class, features);
    }
