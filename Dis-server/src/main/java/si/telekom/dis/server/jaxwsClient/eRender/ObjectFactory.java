...
public class ObjectFactory {
    ...
    private final static QName _CheckinTemplateData_QNAME = new QName("http://templates.mobitel.com/", "data");
    ...
    private final static QName _ConcatTwoPdfsArg0_QNAME = new QName("", "arg0");
    ...
    public JAXBElement<byte[]> createCheckinTemplateData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinTemplateData_QNAME, byte[].class, CheckinTemplate.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinMinorData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinTemplateData_QNAME, byte[].class, CheckinMinor.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinTemplateData_QNAME, byte[].class, Checkin.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createConcatTwoPdfsArg0(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsArg0_QNAME, byte[].class, ConcatTwoPdfs.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinTemplateByTemplateIdData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinTemplateData_QNAME, byte[].class, CheckinTemplateByTemplateId.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinMinorAndSetVersionData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinTemplateData_QNAME, byte[].class, CheckinMinorAndSetVersion.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createAddRenditionData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinTemplateData_QNAME, byte[].class, AddRendition.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetPdfFromOOTemplateArg0(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsArg0_QNAME, byte[].class, GetPdfFromOOTemplate.class, ((byte[]) value));
    }
