...
public class SyncAttsResponse {
    ...
    protected List<si.telekom.dis.server.jaxwsClient.eRender.ArrayList> returns;
     ...
     * {@link si.telekom.dis.server.jaxwsClient.eRender.ArrayList }
     * 
     * 
     */
    public List<si.telekom.dis.server.jaxwsClient.eRender.ArrayList> getReturns() {
        if (returns == null) {
            returns = new java.util.ArrayList<si.telekom.dis.server.jaxwsClient.eRender.ArrayList>();
        }
        return this.returns;
    }
