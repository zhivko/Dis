...
//	@Produces({ MediaType.APPLICATION_JSON })
	...
	// @QueryParam("password") String password, @QueryParam("profileId") String
	// profileId, @QueryParam("attributes") Map<String, List<String>> attributes,
	// Map<String, List<String>> rolesUsers, String templateObjectNameOrFolder)
	// throws Exception {
	// return ExplorerServiceImpl.getInstance().newDocument(loginName, password,
	// profileId, attributes, rolesUsers, templateObjectNameOrFolder);
	// }
	//
	// @GET
	// @Consumes(MediaType.TEXT_HTML)
	...
	// @QueryParam("password") String password, @QueryParam("folderRObjectId")
	// String folderRObjectId, @QueryParam("profileId") String profileId,
	// @QueryParam("attributes") Map<String, List<String>> attributes,
	// @QueryParam("rolesUsers") Map<String, List<String>> rolesUsers,
	// @QueryParam("base64Content") byte[] base64Content, @QueryParam("format")
