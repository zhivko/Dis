 ...
 * generated in the si.telekom.dis.server.jaxwsClient.pdfGenerator package. 
...
public class ObjectFactory {
    ...
    private final static QName _CheckinMinorData_QNAME = new QName("http://templates.mobitel.com/", "data");
    private final static QName _ConcatTwoPdfsResponseReturn_QNAME = new QName("", "return");
    ...
    private final static QName _SetContentContent_QNAME = new QName("http://templates.mobitel.com/", "content");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: si.telekom.dis.server.jaxwsClient.pdfGenerator
     * 
     */
    ...
    public JAXBElement<byte[]> createCheckinMinorData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinMinorData_QNAME, byte[].class, CheckinMinor.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createConcatTwoPdfsResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsResponseReturn_QNAME, byte[].class, ConcatTwoPdfsResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetPdfResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsResponseReturn_QNAME, byte[].class, GetPdfResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinTemplateData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinMinorData_QNAME, byte[].class, CheckinTemplate.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetPdfNewFromKeyValuesResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsResponseReturn_QNAME, byte[].class, GetPdfNewFromKeyValuesResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinMinorData_QNAME, byte[].class, Checkin.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetPdfFromOOTemplateResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsResponseReturn_QNAME, byte[].class, GetPdfFromOOTemplateResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetPdfNewResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsResponseReturn_QNAME, byte[].class, GetPdfNewResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetOpenOfficePdfForHashMapResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ConcatTwoPdfsResponseReturn_QNAME, byte[].class, GetOpenOfficePdfForHashMapResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createAddRenditionData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinMinorData_QNAME, byte[].class, AddRendition.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinMinorAndSetVersionData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinMinorData_QNAME, byte[].class, CheckinMinorAndSetVersion.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createSetContentContent(byte[] value) {
        return new JAXBElement<byte[]>(_SetContentContent_QNAME, byte[].class, SetContent.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCreateDctmObjectContent(byte[] value) {
        return new JAXBElement<byte[]>(_SetContentContent_QNAME, byte[].class, CreateDctmObject.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createCheckinTemplateByTemplateIdData(byte[] value) {
        return new JAXBElement<byte[]>(_CheckinMinorData_QNAME, byte[].class, CheckinTemplateByTemplateId.class, ((byte[]) value));
    }
