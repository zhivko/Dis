...
/**
 * <p>Java class for getPdfMultipleNewWithBarcodesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="getPdfMultipleNewWithBarcodesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getPdfMultipleNewWithBarcodesResponse", propOrder = {
    "returns",
    "barcodes"
})
@XmlRootElement(name = "getPdfMultipleNewWithBarcodesResponse")
public class GetPdfMultipleNewWithBarcodesResponse {

    @XmlElement(name = "return", namespace = "")
    protected List<byte[]> returns;
     ...
     * 
     */
    public List<byte[]> getReturns() {
        if (returns == null) {
            returns = new ArrayList<byte[]>();
        }
        return this.returns;
    }
