...
@XmlType(name = "InvolvmentRoleCollection", propOrder = {
    "involvmentRole"
})
public class InvolvmentRoleCollection {

    protected List<InvolvmentRole> involvmentRole;
     ...
     * This is why there is not a <CODE>set</CODE> method for the involvmentRole property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInvolvmentRole().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InvolvmentRole> getInvolvmentRole() {
        if (involvmentRole == null) {
            involvmentRole = new ArrayList<InvolvmentRole>();
        }
        return this.involvmentRole;
    }
