...
import si.telekom.schemas.common.dealer.v1.DealerInvolvmentRole;
import si.telekom.schemas.common.dealer.v1.PointOfSaleInvolvmentRole;
...
@XmlType(name = "InvolvmentRole", propOrder = {
    "type",
    "subType",
    "involvedId",
    "involvedDirectly"
...
@XmlSeeAlso({
    PointOfSaleInvolvmentRole.class,
    DealerInvolvmentRole.class
})
